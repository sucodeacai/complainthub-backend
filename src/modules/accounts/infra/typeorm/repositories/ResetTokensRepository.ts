...
// Aqui estamos criando um repositório para a entidade ResetToken usando o PostgresDataSource.
...
// A função getRepository é usada para obter um repositório para a entidade ResetToken.
// Portanto, o ResetTokensRepository fornecerá métodos para realizar operações de banco de dados na tabela 'reset_tokens' do banco de dados PostgreSQL.
